...
namespace Jolt
{
    internal static unsafe partial class Bindings
    {
        ...
        public static rmatrix4x4 JPH_BodyInterface_GetWorldTransform(NativeHandle<JPH_BodyInterface> @interface, BodyID bodyID)
        {
            ...
            rmatrix4x4 result;
            UnsafeBindings.JPH_BodyInterface_GetWorldTransform(@interface, bodyID, (JPH_Mat4*)&result);
            return result;
        }
        ...
        public static rmatrix4x4 JPH_BodyInterface_GetCenterOfMassTransform(NativeHandle<JPH_BodyInterface> @interface, BodyID bodyID)
        {
            ...
            rmatrix4x4 result;
            UnsafeBindings.JPH_BodyInterface_GetCenterOfMassTransform(@interface, bodyID, (JPH_Mat4*)&result);
            return result;
        }
        ...
        public static float4x4 JPH_BodyInterface_GetInverseInertia(NativeHandle<JPH_BodyInterface> @interface, BodyID bodyID)
        {
            ...
            float4x4 result;
            UnsafeBindings.JPH_BodyInterface_GetInverseInertia(@interface, bodyID, (JPH_Mat4*)&result);
            return result;
        }
